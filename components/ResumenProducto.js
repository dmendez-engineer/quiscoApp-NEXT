...
const ResumenProducto = ({producto}) => {
    ...
    <div className='shadow p-5 mb-3 flex gap-10 items-center'>
        ...
        <div className='md:w-5/6'>
            ...
            <p className='text-md font-bold  text-gray-700 mt-2'>Subtotal: {formatearDinero(producto.precio*producto.cantidad)}</p>
        ...
        <div>
            ...
            <button type='button'
            className='bg-red-700 flex px-5 py-2 mt-3 text-white rounded-md font-bold uppercase shadow-md w-full'
